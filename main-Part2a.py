...
######################################################
reg = Regression(trainx, trainy, testx, testy, lamb_1, lamb_2, alpha, sigma, degree)
######################################################
save_path_fig_a = os.path.join(save_path_fig,'2-a')
# LS
method = 'LS'
...
print(MAE_LS)
# Plot
plt.scatter(f_LS,np.rint(testy),c='g', s = 10, label = 'Result')
...
plt.savefig(os.path.join(save_path_fig_a,'plot_'+str(method)+".png"), dpi = 100)
plt.show()
######################################################
# RLS
method = 'RLS'
...
print(MAE_RLS)
# Plot
plt.scatter(f_RLS,np.rint(testy),c='g', s = 10, label = 'Result')
temp = np.linspace(min(testy),max(testy),100)
plt.plot(temp, temp, c = 'b', label = r'$y=x$')
plt.xlabel('Prediction Counts', fontsize=18)
plt.ylabel('True Counts', fontsize=18)
...
print(MAE_LASSO)
# Plot
plt.scatter(f_LASSO,np.rint(testy),c='g', s = 10, label = 'Result')
temp = np.linspace(min(testy),max(testy),100)
plt.plot(temp, temp, c = 'b', label = r'$y=x$')
plt.xlabel('Prediction Counts', fontsize=18)
plt.ylabel('True Counts', fontsize=18)
...
print(MAE_RR)
# Plot
plt.scatter(f_RR, np.rint(testy),c='g', s = 10, label = 'Result')
temp = np.linspace(min(testy),max(testy),100)
plt.plot(temp, temp, c = 'b', label = r'$y=x$')
plt.xlabel('Prediction Counts', fontsize=18)
plt.ylabel('True Counts', fontsize=18)
...
print(MAE_BR)
# Plot
plt.scatter(f_BR_mu,np.rint(testy),facecolors='none', edgecolors='g', s = np.diag(f_BR_sigma)*20, label = 'Result w/ size')
temp = np.linspace(min(testy),max(testy),100)
plt.plot(temp, temp, c = 'b', label = r'$y=x$')
plt.xlabel('Prediction Counts', fontsize=18)
plt.ylabel('True Counts', fontsize=18)
...
######################################################
# Save dat
save_path_data_a = os.path.join(save_path_data, '2-a')
thetas = pd.DataFrame()
fs = pd.DataFrame()
errors = pd.DataFrame()
...
thetas.to_csv(os.path.join(save_path_data_a,'thetas.csv'))
...
fs.to_csv(os.path.join(save_path_data_a,'fs.csv'))
...
errors.to_csv(os.path.join(save_path_data_a,'errors.csv'))
